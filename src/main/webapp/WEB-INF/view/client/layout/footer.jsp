            ...
            <div class="row g-4">
                <div class="col-lg-3">
                    <a href="#">
                        ...
                        <p class="text-secondary mb-0">cattuong</p>
                    </a>
                </div>
                <div class="col-lg-3">
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p>Author: Cat Tuong</p>
                    <p>Email: tuong0505ht@gmail.com</p>
                    <p>Phone: +84 901 533 809</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>CatTuong</a>, All
                    right reserved.</span>
            </div>
